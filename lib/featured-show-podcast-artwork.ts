...
export const renderFeaturedShowPodcastArtworkResponse = async (): Promise<ImageResponse> => {
...
export const renderFeaturedShowPodcastArtworkPng = async (): Promise<{
  data: Uint8Array;
  mimeType: string;
}> => {
  const response = await renderFeaturedShowPodcastArtworkResponse();
  return {
