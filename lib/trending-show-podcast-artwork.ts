...
export const renderTrendingShowPodcastArtworkResponse = async (): Promise<ImageResponse> => {
...
export const renderTrendingShowPodcastArtworkPng = async (): Promise<{
  data: Uint8Array;
  mimeType: string;
}> => {
  const response = await renderTrendingShowPodcastArtworkResponse();
  return {
