...
export default function SignInPage() {
  return (
    ...
    >
      <div className="container mx-auto grid min-h-[576px] max-w-5xl items-center gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(22rem,0.8fr)] lg:gap-16">
        <div className="mx-auto max-w-xl text-center lg:mx-0 lg:text-left">
          ...
          <h1
            id="sign-in-heading"
            className="type-page-title font-display text-4xl font-semibold leading-tight tracking-[-0.02em] text-foreground sm:text-5xl"
          >
            Welcome back to the garden.
          </h1>
          <p className="mt-5 text-base leading-[1.75] text-foreground-2 sm:text-lg">
