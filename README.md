...
| `CONVEX_DEPLOY_KEY`                            | Vercel builds           | Use a production key for Production and a Preview-only key beginning `preview:seth-wilson:world-garden\|` for this project's Previews; other key types and scopes fail closed                                   |
